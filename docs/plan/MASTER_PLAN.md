...
| 2026‑09‑14 | 8.1 Core: full endpoint map (+30 endpoints), `headers` on the client, native `refreshToken`, 40 TanStack Query hooks with optimistic like/save/follow; 47 tests, 98 % lines | (this commit) |
