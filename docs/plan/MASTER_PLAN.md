...
| 2026‑09‑15 | Seller product editor: add / edit / delete on `/seller/products[/:id]`, shared upsert schema, mutable mock catalog, `ProductForm` with signed uploads | (this commit) |
